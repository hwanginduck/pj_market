  ...
  <form name="f" method="post" action="member_join_ok.do">
   <table id="join_t">
    ...
    <tr>
     <th>회원비번</th>
     <td>
      <input type="password" name="member_pwd" id="member_pwd" size="14"
      class="input_box" />
     </td>
    </tr>
    ...
    <tr>
     <th>회원비번확인</th>
     <td>
      <input type="password" name="member_pwd2" id="member_pwd2" size="14"
      class="input_box" />
     </td>
    </tr>
    ...
    <tr>
     <th>우편번호</th>
     <td>
      <input name="member_zip1" id="member_zip1" size="5" class="input_box"
    ...
    <tr>
     <th>주소</th>
     <td>
      <input name="member_addr1" id="member_addr1" size="50" class="input_box"
      readonly onclick="post_search()" />
     </td>
    </tr>
    ...
    <tr>
     <th>나머지 주소</th>
     <td>
      <input name="member_addr2" id="member_addr2" size="37" class="input_box" />
     </td>
    </tr>
    <tr>
     <th>휴대전화번호</th>
    ...
    <tr>
     <th>전자우편</th>
     <td>
      <input name="member_email" id="member_email" size="10" 
