...
public class MemberController {
	...
	public String MemberLoginOk(@RequestParam("member_id") String member_id,
			@RequestParam("member_pw") String member_pw, HttpSession session, Model model) throws Exception {
	...
	public String MemberEditOk(MemberDTO member, HttpServletRequest request, HttpSession session, Model model)
			throws Exception {
	...
	public String MemberDelOk(@RequestParam("member_pw") String member_pw, HttpSession session) throws Exception {
